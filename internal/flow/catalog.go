...
// MemoryCatalog is useful for embedded catalogs and deterministic tests.
...
func NewMemoryCatalog() *MemoryCatalog {
	return &MemoryCatalog{Documents: map[string]*Document{}, Schemas: map[string]*Schema{}, Policies: map[string]json.RawMessage{}, Activities: map[string]activity.Spec{}}
}
